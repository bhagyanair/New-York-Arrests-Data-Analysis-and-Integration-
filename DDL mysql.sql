...
CREATE TABLE dim_Location (
	...
	New_Georeferenced_Column_ varchar(200) NULL,
	DI_JobID varchar(20) NULL,
	DI_CreateDate datetime(3) DEFAULT (now(3)) NOT NULL,
...
CREATE TABLE fct_NYCArrests (
	...
	arrest_key varchar(50) NOT NULL default -99,
	arrest_date datetime(3) DEFAULT (now(3)) NULL,
	DI_JobID varchar(20) NULL,
	DI_CreateDate datetime(3) DEFAULT (now(3)) NOT NULL,
	PRIMARY KEY (PD_SK,KY_SK,LAW_CODE_SK, LAW_CAT_SK, ARREST_BORO_SK, ARREST_PRECINCT_SK, JURISDICTION_SK, AGE_GROUP_SK, PERP_SEX_SK, PERP_RACE_SK, LOCATION_SK, arrest_key)
);

-- ------------------------------- STG ------------------------------------------------------------------------
-- use nycarrests
-- stg_NYPD_Arrest_Data__Year_to_Date__tsv 
CREATE TABLE stg_nypd_arrest_data_historic (
	stg_nypd_Arrest_Data_historic_sk int NOT NULL AUTO_INCREMENT,
	...
	latitude varchar(80) NULL,
	longitude varchar(80) NULL,
    Lon_Lat varchar(200) NULL,
	DI_JobID varchar(20) NULL,
	DI_CreateDate datetime(3) DEFAULT (now(3)) NOT NULL,
	PRIMARY KEY (stg_nypd_Arrest_Data_historic_sk)
);
